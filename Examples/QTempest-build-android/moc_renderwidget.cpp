...
#include "../QTempest/renderwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RenderWidget_t, stringdata) + ofs \
...
const QMetaObject RenderWidget::staticMetaObject = {
    { &QTempestWidget::staticMetaObject, qt_meta_stringdata_RenderWidget.data,
...
void *RenderWidget::qt_metacast(const char *_clname)
{
    ...
    return QTempestWidget::qt_metacast(_clname);
}

int RenderWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QTempestWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
