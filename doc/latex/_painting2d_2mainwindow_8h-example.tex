\hypertarget{_painting2d_2mainwindow_8h-example}{\section{Painting2d/mainwindow.\+h}
}
...
\textcolor{preprocessor}{#include <Tempest/SurfaceRender>}
\textcolor{preprocessor}{#include <Tempest/SpritesHolder>}
...
\textcolor{keyword}{class }MainWindow:\textcolor{keyword}{public} \hyperlink{class_tempest_1_1_window}{Tempest::Window} \{
  ...
  \textcolor{keyword}{protected}:
    ...
    \hyperlink{class_tempest_1_1_sprites_holder}{Tempest::SpritesHolder}         spHolder;
    \hyperlink{class_tempest_1_1_surface_render}{Tempest::SurfaceRender}         uiRender;

    \hyperlink{struct_tempest_1_1_point}{Tempest::Point} rotate, mpos;
    \textcolor{keywordtype}{float} zoom;

    \textcolor{keywordtype}{void} paintEvent( \hyperlink{class_tempest_1_1_paint_event}{Tempest::PaintEvent}& e );
